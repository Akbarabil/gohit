...
class MyEventMod extends Model
{
    ...
    protected $allowedFields = ['id_user', 'title', 'date_column', 'time', 'organizer', 'type_sport', 'participant', 'location', 'upload', 'price']; // Kolom yang dapat diisi pada tabel pengguna
